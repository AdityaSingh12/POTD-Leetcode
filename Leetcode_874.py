...
If the robot runs into an obstacle, then it will instead stay in its current location 
...
"""
def robotSim():
    commands=list(map(int, input("Enter destination: ").split()))
    obstacles=list(map(int, input("Enter the obstacles: ").split()))
    x,y,d=0,0,0
